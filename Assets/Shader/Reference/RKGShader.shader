Shader "Reference/Kuwahara/Generalized" {
    Properties {
        _Albedo ("Albedo", Color) = (1,1,1,1)
        _MainTex ("Albedo (RGB)", 2D) = "white" {}
        _KernelSize("Kernel Size", Integer) = 1
        _Q("Sharpness", Range(1.0, 20.0)) = 8
        _Hardness("Hardness", Range(1.0, 20.0)) = 8
        _ZeroCrossing("Zero Crossing", Range(0.01, 2.0)) = 1
    }
    ...
    SubShader {
        ...
        int _KernelSize;
        float _Hardness, _Q, _ZeroCrossing;
